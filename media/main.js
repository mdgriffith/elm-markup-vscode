...
var author$project$Main$editorChange = _Platform_incomingPort('editorChange', elm$json$Json$Decode$value);
		...
		while (true) {
			...
			switch (_n0.$) {
				...
				case 'SelectedFilename':
					var filename = _n0.a;
					var newViewing = function () {
						var _n3 = model.viewing;
						if (_n3.$ === 'Nothing') {
							return elm$core$Maybe$Just(
								{file: filename, selections: _List_Nil, visible: _List_Nil});
						} else {
							var existing = _n3.a;
							return elm$core$Maybe$Just(
								_Utils_update(
				...
				case 'ViewedRanges':
					var viewed = _n0.a;
					var newViewing = function () {
						var _n4 = model.viewing;
						if (_n4.$ === 'Nothing') {
							return elm$core$Maybe$Just(
								{file: viewed.fileName, selections: _List_Nil, visible: viewed.ranges});
						} else {
							var existing = _n4.a;
							return elm$core$Maybe$Just(
								_Utils_update(
									existing,
									{file: viewed.fileName, visible: viewed.ranges}));
						}
					}();
					return _Utils_Tuple2(
						_Utils_update(
				...
				case 'CurrentSelections':
					var current = _n0.a;
					var newViewing = function () {
						var _n5 = model.viewing;
						if (_n5.$ === 'Nothing') {
							return elm$core$Maybe$Just(
								{file: current.fileName, selections: current.selections, visible: _List_Nil});
						} else {
							var existing = _n5.a;
							return elm$core$Maybe$Just(
								_Utils_update(
									existing,
									{file: current.fileName, selections: current.selections}));
						}
					}();
					return _Utils_Tuple2(
						_Utils_update(
				...
				case 'Refresh':
					var current = _n0.a;
					var newViewing = function () {
						var _n6 = model.viewing;
						if (_n6.$ === 'Nothing') {
							return elm$core$Maybe$Just(
								{file: current.fileName, selections: current.selections, visible: current.ranges});
						} else {
							var existing = _n6.a;
							return elm$core$Maybe$Just(
								_Utils_update(
				...
				default:
					return _Utils_Tuple2(
						...
						author$project$Main$notify(
							elm$json$Json$Encode$string('hi')));
			}
		}
	});
